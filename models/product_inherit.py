...
class ProductTemplateInherit(models.Model):
    ...
    @api.constrains("is_laundry_service", "laundry_service_type")
    def _check_laundry_service_type(self):
        for record in self:
            if record.is_laundry_service and not record.laundry_service_type:
                raise models.ValidationError(
                    "Jenis Layanan harus diisi untuk produk layanan laundry!"
                )
